...
TESTING_INFO = 2  # 0 = silent, 1 = progress bar, 2 = one line per epoch
CLASSIFIERS = ["Statistic", "MLP", "CNN", "LSTM", "Transformer"]  # array of classifiers that will be used.
...
FEATURE_VECTOR = "time"  # "time" - time-series, "freq" - frequency feature vectors
